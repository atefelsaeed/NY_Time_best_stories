...
//   String? status;
//
//   // ArticleDataModel? results;
//   List<ArticleDataModel> results = [];
//
//   ArticleModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
//
//     // results = ArticleDataModel.fromJson(json['results']);
//
//     json['results'].forEach((element) {
//       results.add(ArticleDataModel.fromJson(element));
//     });
//   }
// }
//
...
//   String? createdDate;
//
//   List<MultimediaModel> multimedia = [];
//
...
//       multimedia.add(MultimediaModel.fromJson(element));
//     });
//   }
// }
//
...
//   String? image;
//
//   MultimediaModel.fromJson(Map<String, dynamic> json) {
//     image = json['url'];
//   }
// }
